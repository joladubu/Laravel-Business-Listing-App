...
{
//    TO make index and showlisting  available to non-registered users:
    ...
    {
        // Showing all listings and ordering by the date
    ...
    public function store(Request $request)
    {
        ...
        $listing->user_id = auth()->user()->id; // to get logged in user_id
    ...
    public function update(Request $request, $id)
    {
        ...
        //Create Listing
        $listing = Listing::find($id); // id is coming from the url
        $listing->name = $request->input('name');
        $listing->website = $request->input('website');
        $listing->email = $request->input('email');
        $listing->phone = $request->input('phone');
